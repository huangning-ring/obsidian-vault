...
This 揭示了 there must be another pathway to regulate inflammation and calcification. RNA-seq results 提示 us TNFα-NF-κB pathway could be the candidate. It's early investigated that NF-κB