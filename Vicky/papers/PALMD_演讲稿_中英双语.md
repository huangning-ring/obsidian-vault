...
我们检测发现,敲低 PALMD 确实降低了 TNFα 或 IL1β 刺激下 p65 的磷酸化水平；而用化学抑制剂 SC75741 阻断 NF-κB 通路后,PALMD 过表达所诱导的炎症基因(IL1B、TNFAIP3、CXCL2、CASP3、ICAM1)、成骨基因(MSX2、BMP2、ALPL)**全部被显著抑制**。
