...
```table-data
tbl-20260723-parlxusl|rows:6|cols:7|headers:true|width:auto,auto,auto,auto,auto,auto,auto|height:auto,auto,auto,auto,auto,auto|align:left,left,left,left,left,left,left|cellStyles:[{"row":1,"col":1,"textAlign":"left","verticalAlign":"top"},{"row":0,"col":0,"textAlign":"left","verticalAlign":"top"}]|loc:26出国灵感/综述-气道类器官和呼吸道病毒/Part1-AB-试跑检索报告-查准版.md:true
```