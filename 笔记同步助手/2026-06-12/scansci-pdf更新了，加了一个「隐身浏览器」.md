...
author: 川柏同学
source: 微信公众号
url: https://mp.weixin.qq.com/s?__biz=Mzg2NTcyNjU5Ng==&mid=2247493750&idx=1&sn=340bddd85a397c72d461d23cf6479594&chksm=cfcba149e0f7d71f262b6a1b8aacd2f2a747dc7796e7fc7b7475e49fb33957fca088842c3a58&mpshare=1&scene=1&srcid=0613w1p97l0NBU57t15hkne5&sharer_shareinfo=9e909e57063cd951ec19f9f2eab8d636&sharer_shareinfo_first=9e909e57063cd951ec19f9f2eab8d636#rd
saved: 2026-06-12 17:38:06
tags:
  - 笔记同步助手
id: 6ece218f-f577-4d83-bcd1-9c00407a3375
---
公众号名称：植物功能生态
作者名称：川柏同学
发布时间：2026-05-14 16:45
...
[scansci-pdf：给 AI Agent 装一套论文下载系统](https://mp.weixin.qq.com/s?__biz=Mzg2NTcyNjU5Ng==&mid=2247493643&idx=1&sn=74c650d1cd27da0e1a9c0af17d96dbf7&scene=21#wechat_redirect)
...
![[笔记同步助手/2026-06-12/images/07c177a2e3c37b51e815ea1c3841a02f_MD5.png]]
访问被拦截
上一个版本的scansci-pdf对付Cloudflare主要靠两招：curl\_cffi模拟TLS指纹，再加上FlareSolverr浏览器引擎。FlareSolverr本质上是一个跑在Docker里的无头浏览器，能模拟真实浏览器行为，但配置比较重，很多人装不上或者嫌麻烦。
前两天我刷到一篇推文，介绍了一个叫**camofox-browser**的工具。它的思路很有意思：用一个Firefox魔改版浏览器，把显卡指纹、音频指纹、屏幕尺寸、硬件参数这些识别真假用户的关键信息，直接在C++层伪装成真人电脑。然后把这个「伪装浏览器」封装成REST接口，AI Agent调几行API就能用。
...
![[笔记同步助手/2026-06-12/images/7425d1ea13ab2037d556a1b6a103345b_MD5.png]]
Elsevier是反爬最激进的
...
![[笔记同步助手/2026-06-12/images/b522cac27ebed2f624d8fca5ed99e09d_MD5.png]]
出版商页面机构登录
...
**第三，反爬是一场军备竞赛。** 我今天用Camofox绕过了Cloudflare，明天出版商可能就更新了反爬策略。这不是一劳永逸的事情，需要持续跟进。FlareSolverr、Camofox、curl\_cffi，这些工具都是在跟出版商的技术团队打游击战。
...
如果你想要AI帮你读这些论文、做总结、回答问题，你需要把它们构建成一个本地知识库。这里推荐一个群友做的工具**OneFind\[3\]**：
...
![[笔记同步助手/2026-06-12/images/6c1212936b9a793831b6344ab9a7071d_MD5.png]]
onefind梳理领域进展
...
```
更新这个MCP和skill：https://github.com/Rimagination/scansci-pdf
```
![[笔记同步助手/2026-06-12/images/78e7fac79e91d000bcfbe7ae313f0be5_MD5.png]]
更新套件
如果你还没装过，先装：
```
安装这个MCP和skill：https://github.com/Rimagination/scansci-pdf
```
装完之后让Agent运行 `scansci-pdf check` 检查一下环境，看看有没有什么需要配置的。
## 一些心得
...
#### 参考链接
1.  scansci-pdf项目地址: https://github.com/Rimagination/scansci-pdf
2.  paper-fetch-skill项目地址: https://github.com/Dictation354/paper-fetch-skill
3.  OneFind项目地址: https://github.com/iawnfoanaowt/OneFind
***
内容效果不满意？[点此反馈](https://feedback.notebooksyncer.com/feedback/51a09c69_1781282282856?u=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzg2NTcyNjU5Ng%3D%3D%26mid%3D2247493750%26idx%3D1%26sn%3D340bddd85a397c72d461d23cf6479594%26chksm%3Dcfcba149e0f7d71f262b6a1b8aacd2f2a747dc7796e7fc7b7475e49fb33957fca088842c3a58%26mpshare%3D1%26scene%3D1%26srcid%3D0613w1p97l0NBU57t15hkne5%26sharer_shareinfo%3D9e909e57063cd951ec19f9f2eab8d636%26sharer_shareinfo_first%3D9e909e57063cd951ec19f9f2eab8d636%23rd&s=obsidian)