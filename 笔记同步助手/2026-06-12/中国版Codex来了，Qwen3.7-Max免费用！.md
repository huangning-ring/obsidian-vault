...
author: 冷逸
source: 微信公众号
url: https://mp.weixin.qq.com/s/LbLJDG_EAkHdPt303VAUrA
saved: 2026-06-12 12:19:28
tags:
  - 笔记同步助手
id: e4b2c004-8db7-4d3b-8c9b-34a8c709632f
---
公众号名称：沃垠AI
作者名称：冷逸
发布时间：2026-06-08 17:49
大家好，我是冷逸。
...
![[笔记同步助手/2026-06-12/images/6783f05383224b6b6ce15659ceff50b3_MD5.jpg]]
...
![[笔记同步助手/2026-06-12/images/de3c7b91d119e6ca4d60dc8021754a02_MD5.gif]]
如果你用Qwen3.7-Max的话，每天有200次的免费额度。
最关键是，这是中国团队做出来的Codex级产品，不用魔法，所有人都能用。
下面，我带大家沉浸式体验一下。
![[笔记同步助手/2026-06-12/images/b8a893de63891feacb21e52b69d1715c_MD5.jpg]]
一手体验
0）前置准备
首先，前往 qoder.com/desktop，下载安装「Qoder Desktop」。
![[笔记同步助手/2026-06-12/images/ac68bd78bcc390fb59137a62ba507313_MD5.png]]
注意别选错了，不是Qoder Work，也不是Qoder Wake。macOS、Windows、Linux均支持，也有手机APP，可以从手机端遥控桌面Qoder。
![[笔记同步助手/2026-06-12/images/a565eab0dc4e0ac27838ce97a98bde23_MD5.png]]
安装完先看界面。
![[笔记同步助手/2026-06-12/images/6e07e28ac58f2810ba0f10e4b7c225b1_MD5.png]]
...
![[笔记同步助手/2026-06-12/images/1ce5ef31befc2fe7aace47759516d9b7_MD5.png]]
...
![[笔记同步助手/2026-06-12/images/bf4cab766ec7648ba7cb43ebdc7d7a4d_MD5.png]]
上下文通过@的方式调用，可以@具体文件或文件夹；输入斜杠/，是调用具体的Sub-Agent或skill。
![[笔记同步助手/2026-06-12/images/cdf82e3b924e38baff09487d88c084e3_MD5.png]]
说实话，上下文调用这里有一点不太方便：不能像Codex那样直接上传附件，必须用@来引用。体验差了点，希望后续能补上。
1）Case1：多步骤任务
前几天，Anthropic有篇博客很火，叫《When AI builds itself》，全是英文。
![[笔记同步助手/2026-06-12/images/82e66adf1f1346d67c3267cd4ae88401_MD5.png]]
我直接把链接丢给Qoder，让它翻译并生成Markdown文件。
![[笔记同步助手/2026-06-12/images/f4a597bb65beeab7d7628f597a6b8011_MD5.png]]
生成pdf文件。
![[笔记同步助手/2026-06-12/images/14f28b9cb4293857b926bf9cd802b3b0_MD5.png]]
在MD里加数据图，Qoder会自己下载相关图片并嵌入。
![[笔记同步助手/2026-06-12/images/c7a71676ede1fbfaa7ffe72de01df19c_MD5.png]]
最后调用skill生成PPT。
![[笔记同步助手/2026-06-12/images/d70fb32a7bfe1e4136ad628561d6f0fd_MD5.png]]
这是最终的PPT。
![[笔记同步助手/2026-06-12/images/be0fdee5c0db7e4947ba104882fc2538_MD5.gif]]
这一个Quest，就涵盖了browser use、websearch、写脚本、调用skill、图片下载、coding生成这几类不同能力的任务，你通通不用管中间怎么实现，只管下任务、看过程、验收产物。
![[笔记同步助手/2026-06-12/images/23dbf48c1445f21f5346f9705585a4e6_MD5.gif]]
...
![[笔记同步助手/2026-06-12/images/f0f740921377712fe33ae55d24e8153f_MD5.png]]
得益于Qoder的上下文机制，输入@Folders 就可以直接索引整个仓库，它能完整理解项目的目录结构、文件依赖关系和业务逻辑，而不是一个只看单文件的AI。这对重构类任务来说很重要，少了全局视角，重构就是打补丁。
![[笔记同步助手/2026-06-12/images/2fad13428743ac7d3b631475c68a3719_MD5.png]]
Qoder做了完整的代码Review分析。
![[笔记同步助手/2026-06-12/images/16e2077ccd90c931c4bcde0da8816b06_MD5.png]]
然后拆成12步计划进行重构。
![[笔记同步助手/2026-06-12/images/483b81331e8bc666e0af704b029d31f1_MD5.png]]
看一下前后对比：
DeepSeek-V4-Pro：
![[笔记同步助手/2026-06-12/images/ff7e2dca42e9733908ce546bfe98ad83_MD5.png]]
**（可上下滑动，查看全图）**
Qoder优化后：
![[笔记同步助手/2026-06-12/images/0268ae2c11dcfd7565ff63adc1313aa2_MD5.jpg]]
> 📹 此处为视频内容（vid: wxv\_4548097335243079680）（上图为封面），未能直接提取，请前往原文查看：[在公众号原文中观看](https://mp.weixin.qq.com/s/LbLJDG_EAkHdPt303VAUrA)
...
![[笔记同步助手/2026-06-12/images/eef768fac48e183c6779ef7c51814584_MD5.gif]]
这点，比Codex开放多了。
我很早就抢到了智谱的Coding Plan，现在直接把它接进Qoder。不需要管API地址是OpenAI格式还是Anthropic格式，只需要输入key就行。
![[笔记同步助手/2026-06-12/images/7f7b73fc87fbb6f33c93c21b2e2a4263_MD5.png]]
这样，我就能在Qoder里用纯正的glm-5.1了。
![[笔记同步助手/2026-06-12/images/85c06bef38f6ea5e89b5a7f7e3f918ff_MD5.png]]
...
![[笔记同步助手/2026-06-12/images/42b9821540a13aa74eb3009fb13f1fd2_MD5.gif]]
...
![[笔记同步助手/2026-06-12/images/913a2ef89fd035d8bd32138da06bf9ae_MD5.png]]
自建子Agent方式很简单，输入 /create-subagent 就能调用skill来创建。
![[笔记同步助手/2026-06-12/images/1f42973ee59d68135b52e5e876cf0d04_MD5.png]]
专家团有Auto和极致两种模式可选。
![[笔记同步助手/2026-06-12/images/a4445f29fa6de33870e43644a0a25c17_MD5.png]]
日常「极致」模式比较消耗credits（1.6倍），不过他们正在搞活动，付费用户，credits只有0.8倍，背后是Opus 4.8，特别划算。
![[笔记同步助手/2026-06-12/images/95a1738c1c831318d2b81db55bb13383_MD5.jpg]]
写在最后
...
而现在，枪也有了，弹药还是免费的。
***
内容效果不满意？[点此反馈](https://feedback.notebooksyncer.com/feedback/f6988bac_1781263166811?u=https%3A%2F%2Fmp.weixin.qq.com%2Fs%2FLbLJDG_EAkHdPt303VAUrA&s=obsidian)