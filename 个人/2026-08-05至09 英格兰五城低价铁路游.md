...
> **推荐顺序：**Edinburgh → **York → Cambridge → London → Bath → Birmingham** → Manchester → Edinburgh。  
> **铁路：**查询时约 **£305.60／2人**；最后一程采用 Birmingham—Manchester 与 Manchester—Edinburgh 分段购票。  
> **四晚私人房：**查询时折算约 **£368.12／2人**。  
> **铁路＋住宿＋行李核心费用：约 £683.72–£700.72／2人**。  
> **含5项代表性付费景点、节制饮食和市内交通：约 £1,120.12–£1,212.12／2人**，即 **£560.06–£606.06／人**。  
> 选择免费景点替代后，预计可降至 **£883.72–£975.72／2人**。

> [!important] 为什么不是按城市清单原顺序
> Bath 位于西南，Cambridge 位于伦敦东北，York 位于东海岸主线。推荐顺序由北向南再向西，减少折返。  
> 最后从 Birmingham 直接回 Edinburgh 的周日低价班次过早；改为 **Birmingham → Manchester → Edinburgh**，两人约 **£86.20**，比14:07直达方案约 **£118.50** 更低，并把 Birmingham 游览时间延长到17:00。

> [!warning] 查价口径
> 查询时间：**2026-08-03 15:02 GMT**。铁路均按 **2名成人＋1张 Two Together Railcard** 查询；酒店页面以美元显示，本文按约 **£1≈US$1.33**、再计页面标明的20% VAT折算。  
...
flowchart LR
    ...
    H -->|8/9 17:01| M[Manchester Piccadilly]
    M -->|8/9 20:26| E
```
...
| 方向 | 铁路查询价／2人 | 实际影响 | 结论 |
|---|---:|---|---|
| **正向：York→Cambridge→London→Bath→Birmingham** | **£305.60** | York首日约7小时；Birmingham末日约8小时；睡 Cambridge、London、Bath、Birmingham | **推荐；完整住宿链已找到** |
| 反向：Birmingham→Bath→London→Cambridge→York | £342.20 | 首日15:28才到 Birmingham；周六需住 York | 铁路已贵£36.60，且周六York私人房未取得稳定低价完整报价 |
| 正向但 Birmingham 直达 Edinburgh | £337.90左右 | 14:07即离开 Birmingham，且末段约£118.50 | 不如经Manchester拆票 |
...
| 8/9 周日 | Birmingham New Street → Manchester Piccadilly | **17:01–18:29** | 直达 | **£20.70** | [National Rail](https://www.nationalrail.co.uk/journey-planner/?type=single&origin=BHM&destination=MAN&leavingType=departing&leavingDate=090826&leavingHour=17&leavingMin=00&adults=2&railcards=2TR%7C1&extraTime=0) |
| 8/9 周日 | Manchester Piccadilly → Edinburgh | **20:26–23:44** | 1次，查询结果显示经Preston方向 | **£65.50** | [National Rail](https://www.nationalrail.co.uk/journey-planner/?type=single&origin=MAN&destination=EDB&leavingType=departing&leavingDate=090826&leavingHour=20&leavingMin=20&adults=2&railcards=2TR%7C1&extraTime=0) |
|  | **合计** |  |  | **£305.60** |  |

> [!warning] 拆票规则
> Birmingham→Manchester 与 Manchester→Edinburgh 是两张独立票。预留约1小时57分换乘／用餐，但第一段若严重延误，后续Advance票处理仍需按实际票款条件和铁路工作人员指引办理。两人必须全程同行并携带同一张有效Railcard。
...
6. **8/9 Manchester换乘：**不寄存，带箱在站内用餐；20:05前回到站台区域。
...
- **17:01–18:29** Birmingham→Manchester，直达。
- **18:29–20:05** Manchester Piccadilly站内晚餐、休息，不离站远走。
- **20:26–23:44** Manchester→Edinburgh，1次换乘。

> [!warning] Back to Backs是本计划最需要先锁定的景点
> 仅按定时导览开放。官方票务页已显示“25 June onwards”场次，但网页未稳定暴露8月9日具体余票。若无法订到10:00–11:30附近时段，立即改为免费路线，不要为了候补影响17:01列车。
...
| **完整总计** | **£1,120.12** | **£1,212.12** | **£560.06–£606.06／人** |
| 免费景点版总计 | £883.72 | £975.72 | 取消5项付费景点 |
...
- [x] 最后一日经Manchester拆票回Edinburgh，换取更低价格和更多Birmingham时间。
...
1. [ ] 在National Rail逐段重新打开7个查询链接，确认班次仍有同价票。
2. [ ] 先买 **Manchester→Edinburgh 20:26** 与 **Birmingham→Manchester 17:01**，因为它们决定返程可执行性。
